    ...
    public class Dbinitialiser
    {
        public static class DbInitialiser
        {
            public static void Initialise(ApplicationDbContext context)
            {
                ...
                new Module{Title="Object-Oriented Systems Development",Credits=4},
                new Module{Title="Open Source Systems",Credits=4},
                new Module{Title="Introduction to Intelligent Systems",Credits=3},
                ...
                new Enrollment{StudentID=2,ModuleID=3141,Grade=Grade.F},
                new Enrollment{StudentID=2,ModuleID=2021,Grade=Grade.F},
                new Enrollment{StudentID=3,ModuleID=1050},
                new Enrollment{StudentID=4,ModuleID=1050},
                new Enrollment{StudentID=4,ModuleID=4022,Grade=Grade.F},
                new Enrollment{StudentID=5,ModuleID=4041,Grade=Grade.C},
                new Enrollment{StudentID=6,ModuleID=1045},
                new Enrollment{StudentID=7,ModuleID=3141,Grade=Grade.A},
                };
